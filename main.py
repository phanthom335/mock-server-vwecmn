    ...
    Mock Server Vwecmn
    ==================
    Developer-ready web service for cacheing requests with built-in validation.
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-ready web service for cacheing requests with built-in validation.")
